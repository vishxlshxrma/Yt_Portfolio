...
export default function HeroSection() {
  return (
    <div className="p-6 pb-0">
      <div className="relative mb-6 overflow-hidden rounded-lg bg-black" style={{ aspectRatio: "16/9" }}>
        <img
        ...
        <div className="absolute inset-0 bg-black bg-opacity-40 flex items-center justify-center">
          <div className="text-center">
            ...
            <h1 className="mb-2 text-2xl font-bold text-white">My Career Journey | Resume</h1>
            <p className="text-white/80">I tend to look at creative solutions to complex problems.</p>
          </div>
        </div>
      </div>
    </div>
